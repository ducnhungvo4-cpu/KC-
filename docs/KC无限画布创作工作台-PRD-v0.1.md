...
| 支持节点 | 文本节点、图片节点、视频节点、资产节点、素材节点；其中视频节点可携带线性系统分镜信息 |
...
| 用户入口 | 画布右键新建、左侧添加节点、本地上传、资产/素材拖入、视频节点生成结果 |
...
| 用户入口 | 画布右键新建、带分镜信息的视频节点发起生成、图片节点转视频、素材库视频拖入 |
